...
import controller.UpdateItemQuantityController;
...
public class UpdateItemQuantityServlet extends HttpServlet {
    ...
    public UpdateItemQuantityServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(action.equalsIgnoreCase("updateItemQuantity")){
			//continue to updating item quantity in the controller layer
			new UpdateItemQuantityController().processRequest(request,response);
		}else{
			//send back-end type error to the following jsp in case of 'if' condition failure

			request.setAttribute("error",  "back-end error from UpdateItemQuantityServlet");
